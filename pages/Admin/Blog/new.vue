<template>
  <v-row>
    <v-col cols="12">
      <site-page-title :title="'Add Blog Post: ' + postData.title" />
    </v-col>
    <v-col cols="9">
    ...
    <v-col cols="3">
      <v-card class="rounded-0 mb-4">
        ...
        <v-card-actions>
          <v-btn width="100%" color="success" @click="publish">Publish</v-btn>
        </v-card-actions>
      </v-card>
      <v-card class="rounded-0 mb-4">
          ...
          <v-img
            ...
            :src="
              postData.heroImage
                ...
                : 'https://via.placeholder.com/1366x768/000000/ffffff?Text=Blog Placeholder'
            "
          ></v-img>
        </v-card-text>
      </v-card>
...
export default {
  ...
  methods: {
    ...mapActions({
      newPost: "admin/action_add_new_blog",
    }),
    returnLink(text) {
